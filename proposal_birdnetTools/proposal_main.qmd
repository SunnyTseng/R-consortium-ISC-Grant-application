...
|----|----|----|----|
| Phase 1 - consultation & format design | 2025 Dec.1 - 31 | Meet with spOccupancy developers/users to finalize data formats and function specs. | \$704 |
| Phase 2 - Development & prototyping | 2026 Jan.1 - Mar.31 | Implement core functions, create example workflows. | \$3,488 |
